        ...
        class TestTableView: UITableView {
            ...
            fileprivate override func insertRows(at indexPaths: [IndexPath], with animation: UITableViewRowAnimation) {
                ...
                for indexPath in indexPaths {
                    self.insertionExpectations[(indexPath as IndexPath).row]!.fulfill()
                }
            }
            ...
            fileprivate override func deleteRows(at indexPaths: [IndexPath], with animation: UITableViewRowAnimation) {
                ...
                for indexPath in indexPaths {
                    self.deletionExpectations[(indexPath as IndexPath).row]!.fulfill()
                }
            }
    ...
    func testCollectionViewDiffCalculator() {
        ...
        class TestCollectionView: UICollectionView {
            ...
            fileprivate override func insertItems(at indexPaths: [IndexPath]) {
                ...
                for indexPath in indexPaths {
                    self.insertionExpectations[(indexPath as IndexPath).item]!.fulfill()
                }
            }
            ...
            fileprivate override func deleteItems(at indexPaths: [IndexPath]) {
                ...
                for indexPath in indexPaths {
                    self.deletionExpectations[(indexPath as IndexPath).item]!.fulfill()
                }
            }
        ...
        class TestViewController: UIViewController, UICollectionViewDataSource {
            ...
            @objc fileprivate func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
                return diffCalculator.rows.count
            }
            
            @objc fileprivate func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
